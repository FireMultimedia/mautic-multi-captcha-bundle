...
location ~* ^/plugins/MauticMultiCaptchaBundle/Assets/js/.*\.js$ {
...
2. Test the CORS headers:
   ```bash
   curl -I -H "Origin: https://example.com" https://your-mautic-server.com/plugins/MauticMultiCaptchaBundle/Assets/js/altcha.min.js
   ```
